...
test.describe('On Behalf Of — Permission Flow', () => {
  ...
  // test('test 09: verify the approved permission chip, logs status, and Attendance Permissions count', async () => {
  //   await oboPermissionsPage.selectAttendanceEmployee(TARGET_EMPLOYEE_NAME, TARGET_EMPLOYEE_SEARCH);
  //   await oboPermissionsPage.verifyAttendancePermissionChipAndLogs(
  //     secondFormattedDate.cellDate,
  //     'Approved',
  //   );
  //   await oboPermissionsPage.verifyAttendancePermissionsSummaryCount();
  // });
});
